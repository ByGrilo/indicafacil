...
public class AutenticacaoService {
    ...
    public UsuarioConta criarConta(
        String nome,
        String email,
        String telefone,
        String cpf,
        ...
        if (confirmacaoSenha == null || confirmacaoSenha.trim().isEmpty()) {
            throw new IllegalArgumentException("Confirme a senha para continuar.");
        }
        if (!senha.equals(confirmacaoSenha)) {
            throw new IllegalArgumentException("A confirmacao da senha nao bate com a senha digitada.");
        }

        return criarConta(nome, email, telefone, cpf, senha);
    }
    ...
    public UsuarioConta autenticar(String identificador, char[] senha) {
        return autenticar(identificador, senha == null ? "" : new String(senha));
    }
